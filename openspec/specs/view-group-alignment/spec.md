...
Align views.yaml `groups` field naming with DM2DataGroup enum (17 standard data groups), ensuring InstructionBuilder's `search_terms(group)` can precisely match DM2 term group assignments.
